...
public class LessonSeeder implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        seed(1, "Claude.ai Chat", "claude-chat-basics", 1, User.Plan.FREE,
                ...
                "A saved Claude conversation where you explored a topic with follow-up questions");
        ...
        seed(2, "Writing Great Prompts", "writing-great-prompts", 1, User.Plan.FREE,
                ...
                "Three prompt variations you wrote and compared side-by-side");
        ...
        seed(3, "Files & Image Uploads", "files-image-uploads", 1, User.Plan.FREE,
                ...
                "A summary document Claude generated from a file you uploaded");
        ...
        seed(4, "Artifacts & Markdown", "artifacts-markdown", 1, User.Plan.PRO,
                ...
                "A formatted document or mini tool you built with Artifacts");
        ...
        seed(5, "Understanding Claude Plans", "claude-plans-free-vs-pro", 1, User.Plan.PRO,
                ...
                "A personal comparison chart of Claude Free vs Pro for your use case");
        ...
        seed(6, "Projects & System Prompts", "projects-system-prompts", 2, User.Plan.PRO,
                ...
                "A custom system prompt written for your specific job or workflow");
        ...
        seed(7, "Memory & Personalization", "memory-personalization", 2, User.Plan.PRO,
                ...
                "Your Memory preferences configured and tested across conversations");
        ...
        seed(8, "Web Search & Deep Research", "web-search-deep-research", 2, User.Plan.PRO,
                ...
                "A deep research report Claude generated on a topic you chose");
        ...
        seed(9, "Connectors & Integrations", "connectors-integrations", 2, User.Plan.PRO,
                ...
                "A live integration connected and a workflow you ran");
        ...
        seed(10, "Claude Mobile App", "claude-mobile-app", 2, User.Plan.PRO,
                ...
                "A task completed hands-free using Claude voice on mobile");
        ...
        seed(11, "Cowork (Desktop App)", "cowork-desktop-app", 2, User.Plan.PRO,
                ...
                "An automated task you ran using Cowork mode");
        ...
        seed(12, "Claude in Chrome (Browser Agent)", "claude-in-chrome", 3, User.Plan.PRO,
                ...
                "A real webpage task you automated using the browser agent");
        ...
        seed(13, "Claude in Excel & PowerPoint", "claude-excel-powerpoint", 3, User.Plan.PRO,
                ...
                "An AI-enhanced spreadsheet or slide deck you created");
        ...
        seed(14, "Claude Code", "claude-code", 3, User.Plan.PRO,
                ...
                "A working feature or bug fix Claude Code implemented in a real project");
        ...
        seed(15, "Claude API & Building Apps", "claude-api", 3, User.Plan.PRO,
                ...
                "A working API call you wrote that returns a real Claude response");
        ...
        seed(16, "Agents & Orchestration", "agents-orchestration", 3, User.Plan.PRO,
                ...
                "A two-agent workflow you designed and tested");
        ...
        seed(17, "AI-Powered Artifacts (Claude in Claude)", "ai-powered-artifacts", 3, User.Plan.PRO,
                ...
                "A live interactive tool built inside an Artifact");
    ...
    private void seed(int number, String title, String slug, int tier, User.Plan plan,
                      String description, String youtubeSearchQuery, String challenge, String deliverable) {
        ...
        lesson.setDeliverable(deliverable);
